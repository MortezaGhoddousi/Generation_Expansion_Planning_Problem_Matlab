...
switch year
    case 1
        ...
        if inputArg1(((year-1)*5)+3) == 1
            ...
            power_output = wind_turbine_power(weibull_random);
            capacity(3) = capacity(3) + initial_capacity(3) + power_output;
            Cinv = Cinv + inv_cost(3) * initial_capacity(3) * (initial_capacity(3) + power_output);
        end
    case 2
        if inputArg1(((year-1)*5)+1) == 1
            capacity(1) = capacity(1) + initial_capacity(1);
